...
3. If p^alpha divides n and p^alpha > sqrt(2n), we can rule out n. Can we identify all sequences of 11 integers in a row where this holds? those are less than 1% of sequences.
